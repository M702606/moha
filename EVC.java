        ...
        if (pinentering1 == pinentering2) {
            ...
            if (choosingPhase2 > 7) {
                ...
                if (GoaanHAAmaya == 1) {
                    ...
                    System.out.println("waa ku mahaadsantahay istcmaalkaaga ");
                } else if (GoaanHAAmaya > 2) {
                    ...
                    if (Goaan2 == 1) {
                        System.out.println("waxaad  $" + lacgaugushubqofkale + "ugu shubtay" + GalilacgataQofkaKale + "kaan");
                    } else if (Goaan2 == 2) {
                    ...
                    System.out.println("Fadlan dooro lanbarkaa rabtid inaad ku shubatid ");
                    ...
                    if (chooseinrenet == 1) {
                        ...
                        System.out.println("waxaa ku subatay xirmo maalinle ah $" + lacagtaInternetka);
                    } else if (chooseinrenet == 2) {
                        System.out.println("Fadlan gali lacagta ");
                        int lacagtaInternetka = input.nextInt();
                        System.out.println("waxaa ku subatay xirmo isbuucle ah $" + lacagtaInternetka);
                    } else if (chooseinrenet == 3) {
                        System.out.println("Fadlan gali lacagta ");
                        int lacagtaInternetka = input.nextInt();
                        System.out.println("waxaa ku subatay xirmo bille ah $" + lacagtaInternetka);
                    } else if (chooseinrenet == 4) {
                        System.out.println("waa laga noqday codsigaga");
                        System.out.println("MAHADSANID");
                    } else if (chooseinrenet > 4) {
                        System.out.println("waxaa aad dooratay lanbarka cadka ka baxsan 1---4");
                    } else if (kaarkaHadalka == 4) {
                        System.out.println("-ka noqosho-");
                        System.out.println("waa laga noqday codsigaga");
                        System.out.println("MAHADSANID");
                    }
                }
                ...
                System.out.println("mahubtaa inaad inaad u wareejiso " + wareejinlacag + "lacaga dhan $ " + Uwareejinlacag);
                System.out.println("1.haa");
                System.out.println("2.maya");
                ...
                if (goaanwareejin == 1) {
                    ...
                    System.out.println("waalaga noqday codsigaaga");
                    System.out.println("mahadsanid");
                } else if (goaanwareejin > 2) {
                    System.out.println("waxa aad ka baxday xadkaaga");
                ...
                } else if (warbixinkoobanChoice == 2) {
                    System.out.println("-wareejintii ugu danbeesay-");
                    System.out.println("1.udirtay");
                    System.out.println("2.ka heshay");
                    int wareejintiiugudanbeesaychoose = input.nextInt();
                    if (wareejintiiugudanbeesaychoose == 1) {
                        System.out.println("fadlan gali mobilke");
                        int gali = input.nextInt();
                        System.out.println("fadlan gali lacagta");
                        int wareejinlacag = input.nextInt();
                        System.out.println("$" + wareejinlacag + "ayaa u dirrtay " + gali);
                    } else if (wareejintiiugudanbeesaychoose > 2) {
                        System.out.println("out of range MAHADSANID");
                    } else if (wareejintiiugudanbeesaychoose == 2) {
                    }
                }
            ...
            if (choosingPhase2 == 5) {
                ...
                if (salaamBankchoose == 1) {
                    System.out.println("fadlan PIN kaaga");
                    int binksalaam = input.nextInt();
                    float remiderBank = 500;
                    int pinsalaambank = 12345;
                    if (binksalaam == pinsalaambank) {
                        System.out.println("-Hormuud message");
                        System.out.println("Koontada Bankiga Haraageedu waa $ " + remiderBank + "USD");
                    }
                } else if (salaamBankchoose == 2) {
                    System.out.println("Fadlan gali lacagta");
                    int enter = input.nextInt();
                    System.out.println("fadlan gali macluumaadka");
                    int galimacluumaadka = input.nextInt();
                    System.out.println("fadlan gali numbarkaaga sirta ee Bankiga");
                    int sirtaBankiga = input.nextInt();
                    int pinsalaambank = 12345;
                    if (sirtaBankiga == pinsalaambank) {
                        System.out.println("ma hubtaa $ " + enter + "dhigatid accounti-kaaga");
                        System.out.println("1.haa");
                        System.out.println("2.maya");
                        int goaansalaamBank = input.nextInt();
                        if (goaansalaamBank == 1) {
                            System.out.println("-Hormuud message-");
                            System.out.println("waxaa dhigatid $ " + enter + "acounti gaaga ");
                            System.out.println("mahadsanid");
                        } else if (goaansalaamBank == 2) {
                            System.out.println("mahadsanid waalaga noqday codsigaaga");
                            System.out.println("macasalaamo");
                        }
                    }
                } else if (salaamBankchoose == 3) {
                    System.out.println("Fadlan gali lacagta");
                    int enter = input.nextInt();
                    System.out.println("fadlan gali macluumaadka");
                    int galimacluumaadka = input.nextInt();
                    ...
                    int pinsalaambank = 12345;
                    if (sirtaBankiga == pinsalaambank) {
                        System.out.println("ma hubtaa inaad $ " + enter + "ka qaadatid accounti-kaaga");
                        System.out.println("1.haa");
                        System.out.println("2.maya");
                        int goaansalaamBank = input.nextInt();
                        if (goaansalaamBank == 1) {
                            System.out.println("-Hormuud message-");
                            System.out.println("waxaa ka qaadatay $ " + enter + " acounti-gaaga ");
                            System.out.println("mahadsanid");
                        } else if (goaansalaamBank == 2) {
                            System.out.println("mahadsanid waalaga noqday codsigaaga");
                            System.out.println("macasalaamo");
            ...
            if (choosingPhase2 == 4) {
                System.out.println("waa ka baxday ");
                System.out.println("MAHADSANID");
            }
            else
            if (choosingPhase2 > choosingPhase2) {
                System.out.println("waa kabaxday xadkaaga 1---6");
            } else if (choosingPhase2 == 6) {

                System.out.println("-Bixi Biil-");
                System.out.println("Fadlan gali magaca shirkada (Tusaale: Koronto, Biyo, iwm):");
                input.nextLine(); // In case input buffer is not cleared
            ...
            if(choosingPhase2==7) {
                ...
                switch (choice) {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        System.out.println("Doorasho aan sax aheyn. Fadlan isku day mar kale!");                                           break;
                }
            }
            else
            if(choosingPhase2==8) {
